...
?>
            ...
            <div class="top-block">
	            <div class="top-holder">
                  ...
                  <?php if(has_nav_menu('bsan_top_menu')): ?>

					<div class="toolbar-right">  
                        <ul>
							<?php wp_nav_menu(array('theme_location' => 'bsan_top_menu' , 'depth' => 0 , 'container' =>false )); ?>
                        </ul>
...
<?php if(has_nav_menu('bsan_menu')): ?>
<ul id="menu-main-nav">
<?php wp_nav_menu(array('theme_location' => 'bsan_menu' , 'depth' => 0 , 'container' =>false , 'walker' => new description_walker() )); ?>
</ul>
<?php endif; ?>
