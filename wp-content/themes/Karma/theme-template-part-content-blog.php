...
<p class="posted-by-text"><?php the_time('l, F j, Y'); ?></p>
...
<p><?php 
	...
	if( $my_excerpt != ''){
		...
		limit_content(25,  true, '');
	}
?><p>
<a class="permalink" href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><span><?php echo $ka_blogbutton; ?></span></a>
