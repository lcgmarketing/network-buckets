...
<?php
	...
	$tags = array( 'all', 'health', 'tech', 'politics', 'social-media' );
	
	$all_tags = 'health, tech, politics, social-media';
        ...
        <div class="row">
            ...
            <nav class="col-sm-9 sub-menu nav nav-tabs">
                <ul>
                    ...
                    <li><a href="#<?php echo $mbln_tag ?>-health" data-toggle="tab">Health</a></li>
                    <li><a href="#<?php echo $mbln_tag ?>-tech" data-toggle="tab">Technology</a></li>
                    <li><a href="#<?php echo $mbln_tag ?>-politics" data-toggle="tab">Politics</a></li>
                    <li><a href="#<?php echo $mbln_tag ?>-social-media" data-toggle="tab">Social Media</a></li>
                </ul>
            </nav>
