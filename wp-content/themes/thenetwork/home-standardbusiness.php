...
<?php
	...
	$tags = array( 'all', 'personal-finance', 'small-business', 'real-estate' );
	
	$all_tags = 'marketing, personal-finance, small-business, real-estate';
        ...
        <div class="row">
            ...
            <nav class="col-sm-9 sub-menu nav nav-tabs">
                <ul>
                    ...
                    <li><a href="#<?php echo $mbln_tag ?>-personal-finance" data-toggle="tab">Personal Finance</a></li>
                    <li><a href="#<?php echo $mbln_tag ?>-small-business" data-toggle="tab">Small Business</a></li>
                    <li><a href="#<?php echo $mbln_tag ?>-real-estate" data-toggle="tab">Real Estate</a></li>
                </ul>
            </nav>
